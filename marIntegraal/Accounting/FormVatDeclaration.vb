Public Class FormVatDeclaration
...
'		JetGetOrGreater(TABLE_VARIOUS, 1, SetSpacing("17", 20))
'		If KTRL Then
'		Else
'			Do 
...
'					dokumentTot = dokumentTot + Val(AdoGetField(TABLE_VARIOUS, "#v" & VB6.Format(COUNT_TO, "000") & " #"))
'				Next 
'				If dokumentTot Then
...
'					mNode.Text = AdoGetField(TABLE_VARIOUS, "#v090 #") & " " & AdoGetField(TABLE_VARIOUS, "#v091 #")
'				End If
'				bNext(TABLE_VARIOUS)
'				If KTRL Or VB.Left(KEY_BUF(TABLE_VARIOUS), 2) <> "17" Then
'					Exit Do
'				End If
'			Loop 
'		End If
...
'		btwVakken = ""
'		JetGet(TABLE_VARIOUS, 1, SetSpacing("17" & strJaar & strPeriode, 20))
'		If KTRL Then
'			Beep()
...
'		Label2(0).Text = VB6.Format(Val(AdoGetField(TABLE_VARIOUS, "#v092 #")), "00000") & " - " & VB6.Format(Val(AdoGetField(TABLE_VARIOUS, "#v093 #")), "00000")
'		Label2(2).Text = VB6.Format(Val(AdoGetField(TABLE_VARIOUS, "#v096 #")), "00000") & " - " & VB6.Format(Val(AdoGetField(TABLE_VARIOUS, "#v097 #")), "00000")
'		Label2(1).Text = VB6.Format(Val(AdoGetField(TABLE_VARIOUS, "#v094 #")), "00000") & " - " & VB6.Format(Val(AdoGetField(TABLE_VARIOUS, "#v095 #")), "00000")
'		Label2(3).Text = VB6.Format(Val(AdoGetField(TABLE_VARIOUS, "#v098 #")), "00000") & " - " & VB6.Format(Val(AdoGetField(TABLE_VARIOUS, "#v099 #")), "00000")
...
'					lblBEFVak(T).Caption = VB6.Format(Val(AdoGetField(TABLE_VARIOUS, CStr(CDbl("#") + lblBEFVak(T).Tag + CDbl(" #")))) * EURO, "#,##0")
...
'					'UPGRADE_WARNING: Couldn't resolve default property of object lblBEFVak(T).Caption. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
'					'UPGRADE_WARNING: Couldn't resolve default property of object lblBEFVak().Tag. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
'					lblBEFVak(T).Caption = VB6.Format(Val(AdoGetField(TABLE_VARIOUS, CStr(CDbl("#") + lblBEFVak(T).Tag + CDbl(" #")))), "#,##0")
'					'UPGRADE_WARNING: Couldn't resolve default property of object lblEURVak(T).Caption. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
'					'UPGRADE_WARNING: Couldn't resolve default property of object lblBEFVak().Tag. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
'					lblEURVak(T).Caption = VB6.Format(Val(AdoGetField(TABLE_VARIOUS, CStr(CDbl("#") + lblBEFVak(T).Tag + CDbl(" #")))) / EURO, "#,##0.00")
'					'UPGRADE_WARNING: Couldn't resolve default property of object lblEURVak(T).Caption. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
'					lblEvak(T).Text = lblEURVak(T).Caption
'				End If
'			Next 
